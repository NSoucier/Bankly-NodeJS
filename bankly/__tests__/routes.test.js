...
describe("POST /auth/register", function() {
  ...
  // TESTS BUG #3
  test("should allow a user to register as admin", async function() {
    const response = await request(app)
      .post("/auth/register")
      .send({
        username: "uadmin",
...
describe("POST /auth/login", function() {
  ...
  // TESTS BUG #1
  test('should not allow login with incorrect username/password', async function() {
    const response = await request(app)
      .post('/auth/login')
      .send({
        username: "invalid",
...
describe("GET /users", function() {
  ...
  // TESTS BUG #5
  test("should list all users, BASIC info only", async function() {
    const response = await request(app)
      .get("/users")
      .send({ _token: tokens.u1 });
    expect(response.statusCode).toBe(200);
